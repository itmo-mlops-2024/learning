...
def train_model(in_train, in_test, output):
    with mlflow.start_run():
        ...
        params = {"cat_features": ("startingAirport", "destinationAirport")}
        cb_model = CatBoostRegressor(**params).fit(
        ...
        signature = infer_signature(x_test[:SIGNATURE_SIZE], y_pred[:SIGNATURE_SIZE])
